      ...
      getvalues : function (component, event, helper) {
        ...
        action1.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if(results[0]['RFQListId__c']){
                     component.set("v.listviewName",results[0]['RFQListId__c']);
                     component.set("v.selectedListViewName",results[0]['RFQListName__c']);
                     component.set('v.Ispinned', true); 
                     component.set('v.Ispin', false); 
                }
                     if(results[0]['RFQUser__c'] != currentuser ){
                        // alert("hai");
    ...
    getrelatedrfqvendorlist : function(component, event, helper){
            ...
            target: '_self'
               ...
               {label: 'Open RFI', fieldName: 'buildertek__Open_RFI__c', type: 'Number'},
                   ...
                   var rrciddd = component.get("v.rfqrecordId");
                   console.log({rrciddd});
